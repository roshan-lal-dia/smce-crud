        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <?php
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-900 small"><?php echo htmlspecialchars($_SESSION["email"]); ?></span>
                                <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-900"></i>
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?php echo'../user-profile/read.php?id='.$id?>">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>
                                <a class="dropdown-item" href="../reset-password.php?id=">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo'../user-profile/update.php?id='.$id?>">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Edit profile
                                </a>
                                <a class="dropdown-item" href="<?php echo'../user-profile/delete.php?id='.$id?>">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Delete profile
                                </a>
                            </div>
                ...
                <div class="mx-auto d-block" style="width:50%">
                     <img src="img/Exams-rafiki.png" class="img-fluid" alt="Sample image">
                    </div>
