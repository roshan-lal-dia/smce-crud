...
//try regex
    ...
    if(empty($firstname_err) && empty($lastname_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "UPDATE admins SET email=?, password1=? WHERE id=?";
 
        if($stmt = $mysqli->prepare($sql)){
            // Bind variables to the prepared statement as parameters
            $stmt->bind_param("ssi",$param_email, $param_password1, $param_id);
                ...
                <div class="card-body p-md-5">
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                           ...
                           <h3 class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Update Admin's Profile</h3>
